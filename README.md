...
- Agentic mail layer with private daily briefings, source-cited AI-assisted triage, opt-in proactive draft previews, notification filtering and actions, one-click unsubscribe support, local security snapshots, tracker stripping, and phishing-link warnings.
