...
echo "=== Step 4: Installing to ${TARGET_DIR} ==="
...
if cp -R "$APP_PATH" "${TARGET_DIR}/"; then
    ...
    echo "=== Step 4.5: Applying ad-hoc code signature for native features (notifications) ==="
...
echo "=== Step 5: Launching the new version ==="
